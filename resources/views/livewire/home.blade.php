    ...
    <div class="row">
        <div class="col-lg-2 menu">
            <h3 style="padding: 1.5px;">Kategori</h3>
                ...
                </li><li href="" style="list-style: none; padding:2px">
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                        class="icon icon-tabler icons-tabler-outline icon-tabler-category">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-4">
                                    <a href="{{ route('answer.index') }}"
                                        class="btn btn-ghost-secondary w-100 btn-pill">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <form wire:submit="addQuestion">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text"
                                ...
                                wire:model.live="title" placeholder="Start your question with 'What', 'How', 'Why', etc." />
                            @error('title')
