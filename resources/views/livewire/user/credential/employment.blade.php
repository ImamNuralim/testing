                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control @error('position') is-invalid @enderror" wire:model.live.blur="position" />
                                @error('position')
                                ...
                                <input type="text" class="form-control @error('company') is-invalid @enderror" wire:model.live.blur="company"/>
                                @error('company')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <input type="number" class="form-control @error('start_year') is-invalid @enderror" wire:model.live.blur="start_year">
                                @error('start_year')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                @if(!$currently)
                                    ...
                                    <input type="number" class="form-control @error('end_year') is-invalid @enderror" wire:model.live.blur="end_year">
                                    @error('end_year')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
