                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control @error('location') is-invalid @enderror" wire:model.live.blur="location"/>
                                @error('location')
                                ...
                                <input type="text" class="form-control @error('start_year') is-invalid @enderror" wire:model.live.blur="start_year"/>
                                @error('start_year')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
