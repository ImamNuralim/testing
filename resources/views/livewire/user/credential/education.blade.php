                    ...
                    <div class="modal-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <input type="text" class="form-control @error('school') is-invalid @enderror" wire:model.live.blur="school" />
                                @error('school')
                                ...
                                <input type="text" class="form-control @error('major') is-invalid @enderror" wire:model.live.blur="major" />
                                @error('major')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <input type="text" class="form-control @error('degree_type') is-invalid @enderror" wire:model.live.blur="degree_type" />
                                @error('degree_type')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <input type="number" class="form-control @error('graduation_year') is-invalid @enderror" wire:model.live.blur="graduation_year" />
