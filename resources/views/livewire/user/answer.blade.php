                ...
                <div class="row">
                    <div class="col-1">
                        <span class="avatar rounded-circle"
                            style="background-image: url(@if ($answer->user->image == null) 'https://ui-avatars.com/api/?name={{ $answer->user->username }}&background=DE6060&color=fff&rounded=true&size=56' @else {{ asset('storage/' . $answer->user->image) }} @endif)"></span>
                    </div>
                    <div class="col-11" style="padding-left: 30px">
                        <a class="userrname" href="{{ route('profile.index', $answer->user->username_slug) }}"
                            class="text-dark">
                    ...
                    <form wire:submit="edit">
                        ...
                        <div class="modal-body">
                            ...
                            <input type="text"
                                ...
                                wire:model.live="answer_edit" placeholder="Write your answer" />
                            @error('answer_edit')
